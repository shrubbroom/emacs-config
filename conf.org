      ...
      (setq eshell-prompt-regexp "^[#>] ";;"[^#$\n]* at [^#$\n]* in [^#$\n]*\n[#>] "
            eshell-prompt-function #'(lambda nil
                                       (concat
                                        ...
                                        (propertize (system-name) 'face `(:foreground "magenta"))
                                        ...
                                        (propertize (if (= (user-uid) 0) "# " "> ") 'face `(:background (face-background 'default))))))

      ;; (setq eshell-prompt-regexp   "^[^#$\n]* [#>]+ "
      ;;       eshell-prompt-function #'(lambda nil
      ;;                                  (concat
      ;;                                   (propertize (abbreviate-file-name (eshell/pwd)) 'face `(:background (face-background 'default)))
      ;;                                   (propertize (if (= (user-uid) 0) " # " " >>> ") 'face `(:background (face-background 'default))))))
    #+END_SRC
*** FZF fuzzy search
    #+BEGIN_SRC emacs-lisp
