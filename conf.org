...
** Fonts
   ...
   #+END_SRC
   Also fix modeline font
   #+BEGIN_SRC emacs-lisp
     (set-face-attribute 'mode-line nil :font "Sarasa Term Slab SC-16")
     (set-face-attribute 'mode-line-active nil :font "Sarasa Term Slab SC-16")
     (set-face-attribute 'mode-line-inactive nil :font "Sarasa Term Slab SC-16")
        ...
        (list
         (cond
          ((and (projectile-project-p)
                ...
                (not (or (derived-mode-p 'term-mode)
                         (derived-mode-p 'eshell-mode))))
           (concat (centaur-tabs-get-group-name (current-buffer)) "-backends")
           )
...
*** Hydra for tabs
    #+BEGIN_SRC emacs-lisp
      ...
      -^^^^--------------------+-^^^^---------------------+-^^----------------+-^^---------------------------
       ...
       _j_   _k_  switch tab   | _$_^^       select last  | ^^                | ^^
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (global-set-key (kbd "C-t") 'centaur-fast-switch/body)
    #+END_SRC
** Line number
#+BEGIN_SRC emacs-lisp
